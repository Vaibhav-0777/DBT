-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into snowflake_dbt.dbt_schema.customer_incremental as DBT_INTERNAL_DEST
        using snowflake_dbt.dbt_schema.customer_incremental__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
